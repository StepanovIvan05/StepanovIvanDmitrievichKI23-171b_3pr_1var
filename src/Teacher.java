...
class Teacher extends Employee {
  ...
  public Teacher(
      String name, int age, String bossName, int salary, String subject, int numberGroups) {
    super(
        name, age, bossName,
        salary); // Call the parameterized constructor of the superclass (Employee)
  ...
  public int hashCode() {
    return Objects.hash(
        name, age, bossName, salary, subject, numberGroups); // Combine hash codes of all attributes
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o == null || getClass() != o.getClass())
      return false; // If the class types are different, they are not equal
    Teacher teacher = (Teacher) o; // Cast the object to a Teacher
    return age == teacher.age
        && // Compare ages
        salary == teacher.salary
        && // Compare salaries
        numberGroups == teacher.numberGroups
        && // Compare number of groups
        Objects.equals(name, teacher.name)
        && // Compare names
        Objects.equals(bossName, teacher.bossName)
        && // Compare boss names
